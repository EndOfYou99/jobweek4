...
class SeleniumTestFail {
	...
	void testFail() throws InterruptedException {
		...
		if (hiddenword.equals("A*s***_***a**_**s*****s")) {
			...
			WebElement me = driver.findElement(By.id("v"));
			me.click();
			Thread.sleep(500);
			...
			List<WebElement> l = driver.findElements(By.xpath("//*[contains(text(),'You lose!')]"));
		}
		// done
		if (hiddenword.equals("J**j****_*******_****n")) {
			// u, i, t, s, m, a, e,r
			WebElement me = driver.findElement(By.id("x"));
			me.click();
			Thread.sleep(500);
		...
		if (hiddenword.equals("A***a**_*l****_*******ll")) {
			...
			WebElement me = driver.findElement(By.id("c"));
			me.click();
			Thread.sleep(500);
		...
		if (hiddenword.equals("A_*****_****_s***s")) {
			// q, u, i, e, t, j, n, x, l, k
			WebElement me = driver.findElement(By.id("z"));
			me.click();
			Thread.sleep(500);
